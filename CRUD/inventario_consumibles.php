...
include 'app/controllers/getConsumibles.php';
...
<div class="jumbotron">
<h2 align="center">INVENTARIO DE CONSUMIBLES</h2>
      <div class="container">

	  <form align="center" action="postConsumibles.php" method="post">
...
$Consumibles = Consumibles::ningunDato();

$datos = $Consumibles->select();
...
while ($row = $datos->fetch_array()) {
	...
	echo "<td> <a href=\"index1.php?accion=editar&&id=$row[id]\">Editar</a> </td>";
	echo "<td> <a href=\"index1.php?accion=eliminar&&id=$row[id]\">Eliminar</a> </td>";
 ...
 ?>
  ...
  <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-4" align="center">
          <h2>Tornillería</h2>
          <p>Gestión del Stock disponible de Tornillería. Alta, baja y modificación de productos</p>
          <p><a class="btn btn-default" href="inventario_tornilleria.php" role="button">Ir a &raquo;</a></p>
        </div>
      </div>
